# Contrato do módulo — identity

Este documento resume o contrato local de identity. O contrato transversal de headers e webhooks está em [communication-contract.md](communication-contract.md).
