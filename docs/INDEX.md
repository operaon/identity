# Documentação — Identity

> **Status:** documentação versionada em Docs as Code. **Owner:** Identity. **Branch:** main.

Este índice organiza a documentação oficial do repositório [Identity][1]. A documentação global define os padrões; este repositório registra somente responsabilidades, contratos e procedimentos específicos.

## Visão rápida

| Campo | Valor |
| --- | --- |
| Repositório | `identity` |
| Tipo | module |
| Responsabilidade | Identidade, autenticação, sessões, emissão de tokens e RBAC/ABAC dinâmico. |
| Porta declarada | 4700 |
...
É a autoridade para emissão e validação de identidade; regras de acesso não devem ser codificadas como regras fixas de negócio.
